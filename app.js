...
$("#makepdf")?.addEventListener("click", async () => {
  ...
  // 1. Logo und Adresse
  await addImageToPDF(doc, 'logoimg', 16, 15, 36, 36);
  // Adresse unter Logo, Zeilenabstand 6, x=16, y=54
  doc.setFontSize(11).setFont("helvetica", "normal");
  let adr_x = 16, adr_y = 54, adr_ls = 6;
  ...
  doc.text(fuss, 16, 262, { maxWidth: 175 });

  // 8. QR-Zahlteil (PNG)
  await addImageToPDF(doc, 'zahlteilimg', 10, 248, 190, 35);
